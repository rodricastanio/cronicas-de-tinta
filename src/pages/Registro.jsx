        ...
        <div className="reg bg-red-400 p-5">
            ...
            <div className="bg-amber-100 w-full h-190 m-auto rounded-3xl p-8">
                <form className="flex flex-col m-auto items-center justify-center" action="" method="post">
                    ...
                    <div className="sexo-opc flex flex-col gap-2.5">
                        <label className="flex items-center gap-2">
                            <input type="radio" name="sexo" value="hombre" className="align-middle sexoclass" />
                            Hombre
                        </label>

                        <label className="flex items-center gap-2">
                            <input type="radio" name="sexo" value="mujer" className="align-middle sexoclass" />
                            Mujer
                        </label>

                        <label className="flex items-center gap-2">
                            <input type="radio" name="sexo" value="noesp" className="align-middle sexoclass" />
                            No especificado
                        </label>
                    </div>
